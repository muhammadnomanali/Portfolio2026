...
const HEADER_HTML = `<header>
    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            .dropdown-content { position: relative; top: 0; box-shadow: none; border: none; background-color: transparent; margin-left: 15px; min-width: auto; }
            .dropdown-content a { color: rgba(255,255,255,0.85) !important; padding: 8px 12px; }
            .dropdown-content a:hover { background-color: transparent !important; color: #ffffff !important; }
        }
